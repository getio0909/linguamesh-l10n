...
The catalog test suite also verifies the source-revision-34 text-metrics message and its typed
integer placeholders for character and approximate-token counts.
