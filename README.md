...
Catalog `0.1.0` contains 192 messages, including the Android vertical-slice UI, Linux status
announcements, text-file import and translation-export labels, provider-profile controls, onboarding-stage copy, active-provider summaries, completion notifications, draft-locale notes, fixed user-facing error messages, and fixed state-error/category copy, and exercises typed placeholders, plurals,
